...
async def list_tools() -> list[Tool]:
    ...
    return [
        Tool(
            ...
            description="Get basic information (population, finance, etc.) for a Japanese municipality by code or name",
            inputSchema={
                "type": "object",
                "properties": {
                    "jichitai_code": {
        ...
        Tool(
            ...
            description="Get municipality code(s) from municipality name (supports fuzzy matching)",
            inputSchema={
                "type": "object",
                "properties": {
                    "jichitai_name": {
        ...
        Tool(
            ...
            description="Search municipalities by various criteria (population, prefecture, type, financial capability)",
            inputSchema={
                "type": "object",
                "properties": {
                    "population_min": {
